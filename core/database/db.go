			...
			usersScheme = models.DynamicScheme{
				...
				ViewData: &models.ViewData{
					...
					FieldOptions: []models.FieldOptions{
						...
						{Name: "username", Hidden: false, Filterable: true, Order: 5, PreValues: make([]models.PreValue, 0)},
						{Name: "email", Hidden: false, Filterable: true, Order: 6, PreValues: make([]models.PreValue, 0)},
						{Name: "password", Hidden: true, Filterable: false, Order: 7, PreValues: make([]models.PreValue, 0)},
						{Name: "role_id", Hidden: false, Filterable: true, Order: 8, PreValues: make([]models.PreValue, 0)},
						{Name: "avatar", Hidden: false, Filterable: false, Order: 9, PreValues: make([]models.PreValue, 0)},
						{Name: "bio", Hidden: false, Filterable: false, Order: 10, PreValues: make([]models.PreValue, 0)},
					},
				},
				OwnerID: &UserAdmin,
			}
			...
			rolesScheme = models.DynamicScheme{
				...
				ViewData: &models.ViewData{
					...
					FieldOptions: []models.FieldOptions{
						...
						{Name: "updated_at", Hidden: false, Filterable: true, Order: 3, PreValues: make([]models.PreValue, 0)},
						{Name: "deleted_at", Hidden: true, Filterable: false, Order: 4, PreValues: make([]models.PreValue, 0)},
						{Name: "name", Hidden: false, Filterable: true, Order: 5, PreValues: make([]models.PreValue, 0)},
						{Name: "permission", Hidden: false, Filterable: false, Order: 6, PreValues: make([]models.PreValue, 0)},
					},
				},
				OwnerID: &UserAdmin,
			}
