...
type DynamicColumns struct {
	gorm.Model
	DynamicTableID  uint           `gorm:"not null;uniqueIndex:idx_table_column" binding:"required" json:"dynamic_table_id"`
...
type DynamicTable struct {
	...
	DisplayName string            `gorm:"type:text;not null" binding:"required,min=2" json:"display_name"`
	Columns     []*DynamicColumns `gorm:"foreignKey:DynamicTableID" json:"columns"`
}
